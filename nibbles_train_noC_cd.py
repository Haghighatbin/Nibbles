...
from nibbles_env_cd import NibblesEnv
...
def train_dqn_with_obstacles(num_episodes: int = 5000, render_mode: bool = False) -> Tuple[List[float], List[int]]:
    try:
        ...
        console.print(f"[bold red]Training failed due to error:[/bold red]\n{error_details}")
        pygame.quit()
        return [], []
...
if __name__ == "__main__":
    rewards, scores = train_dqn_with_obstacles(num_episodes=10000, render_mode=True)
